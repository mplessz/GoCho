...
reprise : montrer le contraste entre modéliser une diff statique (perte d'emploi ou pas) et modéliser une différence des différences.
...
*===>  Diff statique en 2017, avec les contrôles à l'inclusion
	quietly ologit dep1 traitt $rhs if y>2014  // avec vars de contrôle , sans CEM (sur les 30 000)
	eststo `stub'_en2017, title(`stub' en 2017)
	outreg2 using "$res/`tag'_ologit2017.txt", $outopts eform `replace' ///
